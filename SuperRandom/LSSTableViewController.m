...
#import "LSSTableViewController.h"
#import "LSSMathViewController.h"

@interface LSSTableViewController ()

@property int selectedIndex;

@end

@implementation LSSTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
	if ([segue.identifier isEqualToString:@"pushMath"])
	{
        ...
        [mathVC setHumanCountTo:[self.tableView indexPathForSelectedRow].row];
	}
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    label.text = [NSString stringWithFormat:@"%d humans", indexPath.row];
